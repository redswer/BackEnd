...
public class MyAspect {
	...
	public void myBefore() {
		System.out.println("~~ 프로젝트 과제를 함 => Before");
	}

	// ** After_returning: 핵심적 관심사항 정상종료
	public void myAfter_returning() {
		System.out.println("~~ 200 OK : 회원가입, 게시판 글 등록 잘 됨");
	}

	// ** After_throwing: 핵심적 관심사항 비정상종료
	public void myAfter_throwing() {
		System.out.println("~~ 밤새워 수정 함 => 예외 발생으로 핵심적 관심사항 비정상 종료");
	}

	// ** After: 정상/비정상 관계없이 무조건 시행
	public void myAfter() {
		System.out.println("** finally : 무조건 제출함 => 무조건 종료");
	}
}
