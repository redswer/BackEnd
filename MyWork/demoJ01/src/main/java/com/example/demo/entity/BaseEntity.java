...
//	  DemoJpaApplication.java 에 @EnableJpaAuditing 설정 추가해야 함.
// => @CreatedDate, @LastModifiedDate : 생성일자, 수정일자 자동 등록시 사용

@MappedSuperclass
@EntityListeners(value = { AuditingEntityListener.class })
// => DemoJ01Application.java 에 @EnableJpaAuditing 추가해야 사용 가능함
@Getter
