...
//		===========================================
		...
		if (bip.test("banana", 3))
			System.out.println("** 문자열 길이는 3 초과");
		else
			System.out.println("** 문자열 길이는 3 이하 **");

		if (bip.test("BiPredicate", 5))
			System.out.println("** 문자열 길이는 5 초과");
		else
			System.out.println("** 문자열 길이는 5 이하 **");
