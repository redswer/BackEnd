...
//		Rabbit01 green = new Rabbit01("Green");
		...
		/*
		 * Test2.2) sleepTime없이 우선순위는 서로 다른경우 => MIN -> NORMAL -> MAX
		 */
...
//	               } //catch
		...
		/*
		 * System.out.println("** main Thread info & Priority **"); // main 메서드도 main
		 * 쓰레드 => 다른 쓰레드와 마찬가지로 자신만의 실행 흐름을 이어감 // main 메서드가 종료되어도 남은 쓰레드는 실행됨 // => 모든
		 * 쓰레드가 종료되어야 프로그램은 종료됨.
		 */
