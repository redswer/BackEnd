...
public class Ex10_Properties {
	...
	public static void main(String[] args) {
		// 1. 정의 & 초기화
		// => 동일 key 허용되지 않고, 입력 시에는 나중값이 적용됨
		...
		// pp.setProperty(111, "StudentDelete.Java"); // => String 외의 타입은 컴파일 오류
		pp.put("delete", "StudentDelete.Java");

		System.out.println("Properties => " + pp);
...
//		===================================
		...
		while (epp.hasMoreElements()) {
			...
			System.out.printf("Enumeration : key = %s, getProperty = %s, get = %s\n", eKey, pp.getProperty(eKey),
					pp.get(eKey));
		}
