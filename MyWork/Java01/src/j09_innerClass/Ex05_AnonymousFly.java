...
//		=====================================
		...
		Flyer f2 = new Flyer() {
			@Override
			public void fly() {
				System.out.println("** 2. 익명 클래스 : 오버라이딩 메서드 직접 작성 **");
			}

			// ** 오버라이딩 외의 메서드 추가 : 오류는 없으나 조상의 인스턴스로는 실행 불가능하므로 의미 없음
			public void test() {
...
//		======================================
		// 3. Object 를 상속받는 익명 클래스

		Object ob = new Object() {
			@Override
			public String toString() {
				return "** Object 를 상속받는 익명 클래스 **";
			}

			// ** 오버라이딩 외의 메서드 추가 = 위와 같음
		};
