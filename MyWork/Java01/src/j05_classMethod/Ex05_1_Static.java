...
//	============================
	...
	// => static
	public static int plus(int i, int j, Ex05_1_Static ex05_2) {
	...
	public static int minus(int i, int j, Ex05_1_Static ex05_2) {
		total += (i - j);
		ex05_2.instanceTotal += (i - j);
		return i - j;
	}
...
//	===============================
	...
	// => static
	public static void staticAll(int i, int j, Ex05_1_Static ex05_2) {
		System.out.println("");
	...
	// => instance
	public void instanceAll(int i, int j, Ex05_1_Static ex05_2) {
		System.out.println("");
...
//		=======================================
		...
		// => 경고, 바람직한 접근은 아님
		System.out.println("test2 : " + Ex05_1_Static.total);
