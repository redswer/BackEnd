...
abstract class Animal {
	...
	// => 후손에 의해 생성시 호출됨.
	Animal() {
		System.out.println("** Animal default 생성자 -> 그래도 직접 인스턴스 생성은 불가능 ");
	}
...
class Eagle extends Animal {
	...
	@Override
	void special() {
		System.out.println("~~ 훨훨 높이 날아 다닙니다 ~~");
	}
} // Eagle
...
class Bear {
	...
	void special() {
		System.out.println("~~ 덩치는 크지만 나무를 잘 탑니다 ~~");
	}
}
...
public class Ex01_AbsAnimal {
	...
	public static void main(String[] args) {
		...
		if (new Cat() instanceof Animal)
			System.out.println("** c2 는 Animal 인스턴스 입니다 **");
		else
			System.out.println("** c2 는 Animal 인스턴스가 아닙니다 **");
		...
		// if ( new Bear() instanceof Animal ) System.out.println("** bear 는 Animal 인스턴스
		// 입니다 **");
