	...
	<form action="/Web01/join" method="post">
		<table border="1">
			<tr height="40">
				...
				<td>
					<input type="text" name="name" placeholder="이름입력" size="20"/>
				</td>
			</tr>
			<tr height="40">
				<th bgcolor="aqua">Age</th>
				<td>
					<input type="text" name="age" placeholder="나이입력" size="20"/>
				</td>
			</tr>
			<tr height="40">
			...
			<tr height="40">
				...
				<td>
					<input type="text" name="point" placeholder="점수입력" size="20"/>
				</td>
			</tr>
			<tr height="40">
				<th bgcolor="aqua">Birthday</th>
				<td>
					<input type="date" name="birthday" placeholder="생일입력" size="20"/>
				</td>
			</tr>
			<tr height="40">
