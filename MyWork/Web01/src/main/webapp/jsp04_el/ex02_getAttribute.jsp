...
-> pageContext 에 정의된 name 이 호출됨
-> 가장 가까운 범위부터 넓은 범위로 적용됨 (page < request < session < application)
-> 구별하여 출력하려면 해당 영역을 속성명 앞에 붙여서 출력 (ex : request.name)
	<b>
...
3.2) EL
<b>
\${requestScope.num1} + \${request.Scope.num2} = ${num1 + num2}</b>
	<hr width="50%" align="left">
3.3) Parameter: Java
=> 쿼리스트링에 ?num1=300&num2=777 추가하고 test
	<%
